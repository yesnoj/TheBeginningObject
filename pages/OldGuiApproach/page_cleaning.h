...
/**
 * @file page_cleaning.h
 *
 */


#ifndef PAGE_CLEANING_H
#define PAGE_CLEANING_H
...
static void event_clean_style_delete(lv_event_t * e)
{
    lv_event_code_t code = lv_event_get_code(e);

    if(code == LV_EVENT_DELETE) {
        lv_style_reset(&style_btn_back_clean);
...
{   
    ...
    lv_scr_load(screen_cleaning);

    lv_obj_set_style_bg_color(screen_cleaning, LV_COLOR_MAKE(255, 255, 255), LV_PART_MAIN);
 ...
 *********************/
    ...
    lv_label_set_text(title, dev_clean_cleaning_title_txt);
    lv_obj_set_style_text_color(screen_cleaning, lv_color_hex(BLACK), LV_PART_MAIN);
    lv_obj_set_style_text_font(title, &lv_font_montserrat_22, 0);
    lv_obj_align(title, LV_ALIGN_TOP_LEFT, 10 , 10);  

    lv_obj_t * subTitle = lv_label_create(screen_cleaning);
    ...
    remainingTime = lv_label_create(screen_cleaning);
    ...
    lv_obj_t * btn_back = lv_button_create(screen_cleaning);
    ...
    lv_obj_add_event_cb(btn_back, event_clean_style_delete, LV_EVENT_DELETE, NULL);
    ...
    lv_style_init(&style_btn_back_clean);
    lv_style_set_bg_color(&style_btn_back_clean, lv_color_hex(GREEN));
    lv_style_set_border_color(&style_btn_back_clean, lv_color_hex(GREEN_DARK));
    lv_style_set_border_width(&style_btn_back_clean, 3);
    lv_style_set_shadow_width(&style_btn_back_clean, 10);
    lv_style_set_shadow_offset_y(&style_btn_back_clean, 5);
    lv_style_set_shadow_opa(&style_btn_back_clean, LV_OPA_50);
    lv_obj_add_style(btn_back, &style_btn_back_clean, 0);
 ...
 *********************/
    ...
    totalProgress_bar = lv_bar_create(screen_cleaning);
    ...
    lv_obj_t * totalProgress_label = lv_label_create(screen_cleaning);
    ...
    lv_obj_t * cycleProgress_label = lv_label_create(screen_cleaning);
    ...
    lv_obj_t * stepProgress_label = lv_label_create(screen_cleaning);
    ...
    stepProgress_value = lv_label_create(screen_cleaning);
    ...
    createMessageBox(dev_clean_cleaning_title_txt, dev_clean_cleaning_Complete , buttonCancel_label, buttonOK_label);
}
