...
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN
    ...
    #define LV_MEM_SIZE (224U * 1024U)        /*[bytes]*/
...
#define LV_FONT_CUSTOM_DECLARE //LV_FONT_DECLARE(FilMachineFontIcons_15) LV_FONT_DECLARE(FilMachineFontIcons_20) LV_FONT_DECLARE(FilMachineFontIcons_30) LV_FONT_DECLARE(FilMachineFontIcons_40) LV_FONT_DECLARE(FilMachineFontIcons_100) 
